...
$xcrud->table_name(' ');
$xcrud->columns('alias,razon_social,localidad,rfc,proveedor_contacto_ventas.email,proveedor_contacto_pagos.email');
$xcrud->column_name('proveedor_contacto_ventas.email','Email Ventas');
